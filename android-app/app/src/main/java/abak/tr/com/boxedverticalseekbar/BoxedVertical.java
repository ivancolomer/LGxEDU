...
public class BoxedVertical extends View{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textStyle = a.getInteger(R.styleable.BoxedVertical_textStyle, FONT_NORMAL);
        ...
        if(containsFlag(textStyle, FONT_BOLD) && containsFlag(textStyle, FONT_ITALIC)) {
            mTextPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD_ITALIC));
        } else if(containsFlag(textStyle, FONT_BOLD)) {
            mTextPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        } else if(containsFlag(textStyle, FONT_ITALIC)) {
